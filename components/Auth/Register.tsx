...
/>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                className="block disabled:opacity-50 w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          ...
          <Link href="/auth/signin" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 pl-1">
            Sign in
          </Link>
        </p>
      </div>
